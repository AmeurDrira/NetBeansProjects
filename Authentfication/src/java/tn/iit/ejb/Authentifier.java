...
public class Authentifier extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       HttpSession session = request.getSession();
        ...
        if ("Ameur".equalsIgnoreCase(nom) && "Drira".equalsIgnoreCase(prenom)) {
            session.setAttribute("autoriser", "oui");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String prenom = request.getParameter("prenom");
        //System.out.println(prenom);
        if ("aa".equalsIgnoreCase(nom) && "aa".equalsIgnoreCase(prenom)) {
            session.setAttribute("autoriser", "oui");
            response.sendRedirect("index.jsp");
        } else {
            Integer p = (Integer) session.getAttribute("n");
